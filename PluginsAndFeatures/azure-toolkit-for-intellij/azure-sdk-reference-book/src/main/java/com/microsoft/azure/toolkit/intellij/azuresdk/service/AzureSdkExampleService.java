...
public class AzureSdkExampleService {
    ...
    @AzureOperation(name = "boundary/sdk.load_artifact_example.url", params = "entity.getRawUrl()", type = AzureOperation.Type.REQUEST)
    ...
    @AzureOperation(name = "boundary/sdk.load_library_examples_entities", type = AzureOperation.Type.TASK)
    ...
    @AzureOperation(name = "boundary/sdk.load_library_example_entities", type = AzureOperation.Type.TASK)
